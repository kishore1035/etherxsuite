...
export function InsertCellsMenu({ isOpen, onClose, isDarkMode, triggerRef }: InsertCellsMenuProps) {
  ...
  const menuItems = [
    { id: 'shift-right' as InsertAction, label: 'Shift Cells Right', icon: <ArrowRight className="w-5 h-5" /> },
    { id: 'shift-down' as InsertAction, label: 'Shift Cells Down', icon: <ArrowDown className="w-5 h-5" /> },
    { id: 'row-above' as InsertAction, label: 'Insert Row Above', icon: <RowsIcon className="w-5 h-5" />, hasCount: true },
    { id: 'row-below' as InsertAction, label: 'Insert Row Below', icon: <RowsIcon className="w-5 h-5" />, hasCount: true },
    { id: 'col-left' as InsertAction, label: 'Insert Column Left', icon: <Columns className="w-5 h-5" />, hasCount: true },
    { id: 'col-right' as InsertAction, label: 'Insert Column Right', icon: <Columns className="w-5 h-5" />, hasCount: true },
  ];
